...
- **🍯 Deploying a T-Pot (Honeypot VM)** — Deployed T-pot to capture real-time data of attacker's TTP's
...
- 💻 [GitHub Projects](https://github.com/JustinSalvi?tab=repositories)  
